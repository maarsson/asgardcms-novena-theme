                ...
                <div class="row">
                    <div class="col-lg-12 mb-5">
                        <div class="single-blog-item">
                            <img alt="" class="img-fluid" src="/themes/novena/images/blog/blog-1.jpg">
                                <div class="blog-item-content mt-5">
                                    <div class="blog-item-meta mb-3">
                                        <span class="text-color-2 text-capitalize mr-3">
                                            <i class="icofont-book-mark mr-2">
                                            </i>
                                            Equipment
                                        </span>
                                        <span class="text-muted text-capitalize mr-3">
                                            <i class="icofont-comment mr-2">
                                            </i>
                                            5 Comments
                                        </span>
                                        ...
                                        <ul class="float-right list-inline">
                                            ...
                                            <li class="list-inline-item">
                                                <a href="#" target="_blank">
                                                    <i aria-hidden="true" class="icofont-facebook">
                                                    </i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="#" target="_blank">
                                                    <i aria-hidden="true" class="icofont-twitter">
                                                    </i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="#" target="_blank">
                                                    <i aria-hidden="true" class="icofont-pinterest">
                                                    </i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="#" target="_blank">
                                                    <i aria-hidden="true" class="icofont-linkedin">
                                                    </i>
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <div class="comment-area mt-4 mb-5">
                            ...
                            <ul class="comment-tree list-unstyled">
                                <li class="mb-5">
                                    <div class="comment-area-box">
                                        <div class="comment-thumb float-left">
                                            <img alt="" class="img-fluid" src="/themes/novena/images/blog/testimonial1.jpg">
                                            </img>
                                        </div>
                                        ...
                                        <div class="comment-meta mt-2">
                                            <a href="#">
                                                <i class="icofont-reply mr-2 text-muted">
                                                </i>
                                                Reply
                                            </a>
                                        </div>
                                ...
                                <li>
                                    <div class="comment-area-box">
                                        <div class="comment-thumb float-left">
                                            <img alt="" class="img-fluid" src="/themes/novena/images/blog/testimonial2.jpg">
                                            </img>
                                        </div>
                                        <div class="comment-info">
                                            <h5 class="mb-1">
                    ...
                    <div class="col-lg-12">
                        <form class="comment-form my-5" id="comment-form">
                            ...
                            <textarea class="form-control mb-4" cols="30" id="comment" name="comment" placeholder="Comment" rows="5">
                            </textarea>
                            <input class="btn btn-main-2 btn-round-full" id="submit_contact" name="submit-contact" type="submit" value="Submit Message">
                            </input>
                        </form>
                    </div>
                </div>
